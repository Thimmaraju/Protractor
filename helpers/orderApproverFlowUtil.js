...
function verifyApproverOrderStatus(orderObject) {
	ordersPage.openApproverPage();
	browser.sleep(5000);
...
async function waitForApproverOrderStatusChangeWithAsyncAwait(orderObject, expectedChangedStatus) {
    currentRepeatCount = currentRepeatCount+1;
    ordersPage.openApproverPage();
    ordersPage.searchBuyerOrderNumber(orderObject.orderNumber);
    //ordersPage.clickFirstViewDetailsOrdersTable();
...
module.exports = {
    	verifyApproverOrderStatus:	verifyApproverOrderStatus,
	    ...
	    waitForDeleteOrderStatusChange:waitForDeleteOrderStatusChange,
   	 	waitForApproverOrderStatusChangeWithAsyncAwait: waitForApproverOrderStatusChangeWithAsyncAwait,
