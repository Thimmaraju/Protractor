...
var logGenerator = require("../../../../helpers/logGenerator.js"),
    ...
    objectStorageAccountS3Template = require('../../../../testData/OrderIntegration/Softlayer/ObjectStorageAccountS3.json'),
...
describe('Tests for Softlayer : Object STorage Account - S3', function () {
    ...
    var slOsaJsonObject = JSON.parse(JSON.stringify(objectStorageAccountS3Template));
    ...
    it('Object Storage S3 Account- Verify Softlayer Object Storage S3 Account Main Page parameters', function () {
        var orderObject = {};
        var slOsaJsonObject = JSON.parse(JSON.stringify(objectStorageAccountS3Template));
        catalogPage.searchForBluePrint(slOsaJsonObject.bluePrintName);

        //Verify correct service name is displayed on the catalog page for Object Storage S3 Account
        ...
        // //Verify the provider to be Softlayer for Object Storage S3 Account
        ...
        // //Verifty "Starting At" price for Object Storage S3 Account
        ...
        catalogPage.clickConfigureButtonBasedOnName(objectStorageAccountS3Template.bluePrintName);
    ...
    it(' Object Storage S3 Account-Verify Softlayer Softlayer Object Storage S3 review Parameters on review order', function () {
        var orderObject = {};
        var slOsaJsonObject = JSON.parse(JSON.stringify(objectStorageAccountS3Template));
        catalogPage.searchForBluePrint(slOsaJsonObject.bluePrintName);
        catalogPage.clickConfigureButtonBasedOnName(objectStorageAccountS3Template.bluePrintName);
        orderObject.servicename = serviceName;
        orderFlowUtil.fillOrderDetails(objectStorageAccountS3Template, modifiedParamMap).then(function (requiredReturnMap) {
    ...
    it(' Object Storage S3 Account- Verify View Order Details for Softlayer Object Storage S3', function () {
        var orderObject = {};
        var slOsaJsonObject = JSON.parse(JSON.stringify(objectStorageAccountS3Template));
        catalogPage.searchForBluePrint(slOsaJsonObject.bluePrintName);
        catalogPage.clickConfigureButtonBasedOnName(objectStorageAccountS3Template.bluePrintName);
        orderObject.servicename = serviceName;
        orderFlowUtil.fillOrderDetails(objectStorageAccountS3Template, modifiedParamMap);
    ...
    if (isProvisioningRequired == "true") {
        it(' Object Storage S3 Account- Verify Inventory / output parameters Details for Softlayer Object Storage S3', function () {
            var orderObject = {};
            var slOsaJsonObject = JSON.parse(JSON.stringify(objectStorageAccountS3Template));
            catalogPage.searchForBluePrint(slOsaJsonObject.bluePrintName);
            catalogPage.clickConfigureButtonBasedOnName(objectStorageAccountS3Template.bluePrintName);
