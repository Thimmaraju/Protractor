...
var logGenerator = require("../../../../helpers/logGenerator.js"),
    ...
    fileStorageTemplate = require('../../../../testData/OrderIntegration/Softlayer/FileStoragePerformance.json'),
...
describe('Tests for Softlayer - File Storage Service - Performance Type ', function () {
    var catalogPage, placeOrderPage, mainParameterServiceName,ordersPage, inventoryPage, catalogDetailsPage, serviceName;
    ...
    it('TC-	C196030 : File Storage - Performance Type Main Page parameters', function () {
        var orderObject = {};
        var slFsJsonObject = JSON.parse(JSON.stringify(fileStorageTemplate));
    ...
    it('TC-C196031 : File Storage - Performance Type  Additional Parameters on review order', function () {
        var slFsJsonObject = JSON.parse(JSON.stringify(fileStorageTemplate));
        catalogPage.searchForBluePrint(slFsJsonObject.bluePrintName);
        catalogPage.clickConfigureButtonBasedOnName(fileStorageTemplate.bluePrintName);
    ...
    it('TC-C196032 : File Storage - Performance Type : Verify View Order Details File Storage', function () {
        var orderObject = {};
        var slFsJsonObject = JSON.parse(JSON.stringify(fileStorageTemplate));
        catalogPage.searchForBluePrint(slFsJsonObject.bluePrintName);
        catalogPage.clickConfigureButtonBasedOnName(fileStorageTemplate.bluePrintName);
    ...
    if (isProvisioningRequired == "true") {
        it('TC-C196033 :File Storage - Performance Type  : Verify Order Approval, verifying  Inventory View Details, Delete Order', function () {
            var orderObject = {};
            var slFsJsonObject = JSON.parse(JSON.stringify(fileStorageTemplate));
            catalogPage.searchForBluePrint(slFsJsonObject.bluePrintName);
            catalogPage.clickConfigureButtonBasedOnName(fileStorageTemplate.bluePrintName);
