...
describe('Azure: Test cases for DNS Zone', function () {
        ...
        it('Azure: TC-T386495 verify that for DNS Zone Service all parameters on Review Order page matches with input.', function () {
        ...
        it('Azure: TC-T386496 verify that for DNS Zone Service all values on ‘View Order Details’ page matches with input.', function () {
