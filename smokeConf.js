...
exports.config = {
    ...
    suites: {
        	'AWS': 'e2e/specs/orderIntegration/AWS/snsAWS.spec.js',
        	'Azure': 'e2e/specs/orderIntegration/Azure/networkSecurityGroup.spec.js',
    	    'SL': 'e2e/specs/orderIntegration/Softlayer/securityGroupService.spec.js',
        	//'GCP': 'e2e/specs/orderIntegration/Google/computeGCP.spec.js'
    },
    ...
    onComplete: async function(){
        ...
        await postToSlack().then(function () {
            reportGenerator.generateHTMLReport('Smoke Test Suite');
        });
